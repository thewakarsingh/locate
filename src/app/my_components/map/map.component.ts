...
// layerControl.addOverlay(parks, "Parks");
  ...
  locateMe(){
    ...
    this.getCurrentPosition().then(res=>{
      ...
      var url2='https://api.openweathermap.org/data/2.5/forecast/daily?lat='+res.lat+'&lon='+res.lng+'&appid=3b5a27eca817cf9eac1374c7d17b546c&units=metric';

      var resultW=this.http.get(url2);
   // var a=res[0].name;
